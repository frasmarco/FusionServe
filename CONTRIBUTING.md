...
Welcome to `FusionServe` contributor's guide.
...
If you experience bugs or general issues with `FusionServe`, please have a look
...
You can help improve `FusionServe` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`FusionServe` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `FusionServe`'s files. While this mechanism can
...
```
conda create -n FusionServe python=3 six virtualenv pytest pytest-cov
conda activate FusionServe
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/FusionServe.git
   cd FusionServe
   ```
...
5. Install [pre-commit]:
   ...
   `FusionServe` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/FusionServe
[issue tracker]: https://github.com/<USERNAME>/FusionServe/issues
